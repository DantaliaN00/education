...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.state = (self.startingPosition, frozenset())
...
def cornersHeuristic(state, problem):
    ...
    for corner in unvisitedCorners:
        temp = manhattanDistance(currentPosition, corner)
        if temp > distance:
            distance = temp
...
def foodHeuristic(state, problem):
    ...
    for food1 in foodsList:
        for food2 in foodsList:
            if (food1, food2) in problem.heuristicInfo:
                ...
                #problem.heuristicInfo[(food1, food2)] = manhattanDistance(food1, food2)
    ...
    for food in foodsList:
        if (position, food) in problem.heuristicInfo:
            ...
            #problem.heuristicInfo[(position, food)] = manhattanDistance(position, food)
...
class ApproximateSearchAgent(Agent):
    ...
    def registerInitialState(self, state):
        ...
        startPos = state.getPacmanPosition()
        foods = state.getFood()
        ...
        "yep.. welcome to real world! -_-"

        self.actions.append('East')
        self.actions.append('East')
        self.actions.append('East')
        self.actions.append('East')
        self.actions.append('North')
        self.actions.append('North')
        self.actions.append('West')
        self.actions.append('West')
        self.actions.append('West')
        self.actions.append('North')
        self.actions.append('North')
